...
- **[Tokenizing SAS Advisory Company](##):** This company based in Cartagena, Colombia provides you with all the necessary advice so that you learn all the technology of Bitcoin Latino and Bitcoin Cash and start developing your own currency based in Bitcoin Cash or other types of applications, such as loyalty points for your business, tokenization of tickets and tickets, tickets for events, anything capable of transferring its value. Go to **[Tokenizing SAS](https://tokenizando.wixsite.com/tokenizando)**
...
The following projects are experimental in nature and not meant to attract retail investment. If you don't know how cryptocurrency works do not attempt to invest your money into them.
